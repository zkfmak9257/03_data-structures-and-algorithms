package com.kang.section06.tree;

import java.util.ArrayList;
import java.util.List;

/* 이진 트리(Binary Tree)
 *  - 각 노드가 최대 두개의 자식(L,R)을 가지는 구조
 *
 ...
 *
 *  - 이러한 정렬 속성 덕분에 탐색, 삽입, 삭제 연산을 효율적으로 수행 가능하다.
 *    (평균이 O(log n))
...
public class BinarySearchTree<T extends Comparable<T>> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("전위 순회 : " + bst.postOrder());

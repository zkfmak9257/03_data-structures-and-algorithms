package com.mins.sectiom01.timecomplexity;
...
public class Application {
  public static void main(String[] args) {
    ...
    System.out.println("지수 시간 O(2^n) 결과 : " + fibonacci(100));
...
//      int mid = left + (right - left) / 2;
      ...
      if (target == arr[mid]) return mid; // 가운데롤 나타내는 인덱스를 반환

      // 2. 찾으려는 targer이 중간보다 크다면
      //    (mind 보다 오른쪽에 있을 경우)

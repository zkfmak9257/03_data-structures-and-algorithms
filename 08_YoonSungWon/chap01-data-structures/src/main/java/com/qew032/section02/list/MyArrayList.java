package com.qew032.section02.list;
...
public class MyArrayList<T> {
     ...
     *
     * @SuppressWarnings("unchecked") - 해당 부분에서 발생하는 제네릭 관련 안정성 경고를 무시해라
     * 컴파일러에게 알려주는 어노테이션
     */
    ...
    public MyArrayList(int intialCapacity) {
        ...
        if (intialCapacity < 0) {
            throw new IllegalArgumentException("잘못된 용량 : " + intialCapacity);
        }

        data = (T[]) new Object[intialCapacity];
        size = 0;   // 저장된 요소 개수 0개
    }
     ...
     * 제거된 요소를 반환.
     * 시간 복잡도는 O(n) - 제거된 요소 뒤 모든 요소를 한칸씩 당겨야됨
     *
     * @param index 제거된 요소
     * @return
     */

...
* java 제공 Stack 클래스
* - java.util 패키지
* - Vector 클래스를(List 비슷, 내부 배열 사욜) 상속하여 만들어짐
...
public class Application {
    public static void main(String[] args) {
        ...
        //  EmptyStackException이 발생된다
        if (stack != null && !stack.isEmpty()) {
            System.out.println("peek() 결과 :" + stack.peek());
            System.out.println("peek() 호출 후 결과 :" + stack); // 유지되는지 더블체크
        }
        System.out.println("=============== Stack에서 마지막 요소를 제거/뽑아내는 - pop() ====================");

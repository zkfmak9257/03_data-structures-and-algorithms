...
public class Application1 {
    public static void main(String[] args) {
        ...
        deque.addFirst(6);
        System.out.println("addFirst 후 deque : " + deque); // [6, 1, 2, 3, 4, 5]

        System.out.println("========== 덱에 맨 앞/뒤 요소 확인 - getFirst, getLast ==========");
        System.out.println("getFirst() 결과 : " + deque.getFirst()); // 6
        System.out.println("getLast() 결과 : " + deque.getLast()); // 5
        System.out.println("getXXX 동작 이후  deque : " + deque); // [6, 1, 2, 3, 4, 5]

        System.out.println("========== 덱에 맨 앞/뒤 요소 확인 - removeFirst, removeLast ==========");
        System.out.println("removeFirst() 결과 : " + deque.removeFirst()); // 6
        System.out.println("removeLast() 결과 : " + deque.removeLast()); // 5
        System.out.println("removeXXX 동작 이후  deque : " + deque); // [1, 2, 3, 4]

        System.out.println("========== 덱에 맨 앞/뒤 요소 확인 - removeFirst, removeLast ==========");
        System.out.println("removeFirst() 결과 : " + deque.removeFirst()); // 1
        System.out.println("removeLast() 결과 : " + deque.removeLast()); // 4
        System.out.println("removeXXX 동작 이후  deque : " + deque); // [2, 3]
        ...
        System.out.println("is Empty() 결괴 : " + deque.isEmpty() ); // false = 안비어있음, true = 비어있음
    }
}

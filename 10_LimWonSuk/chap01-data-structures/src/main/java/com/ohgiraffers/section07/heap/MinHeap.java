...
/*
* Heap : 완전 이진 트리 구조 + 우선 순위 큐 구현을 위한 자료 구조
* - 부모 자식 간의 우선순위만 보장, 자식순서(L or R)은 특별한 순서 X
*
*최소 힙 (Min Heap)
* - 작은 값이 우선 순위가 높은 힙
* */
...
public class MinHeap<T extends Comparable<T>> {
    ...
    public void add(T data) {
        ...
        heapifyUp(heap.size() - 1); // 마지막 인덱스 값
    }
    ...
    private void heapifyUp(int index) {
        ...
        while (index > 0) {
            ...
            int parentIndex = (index - 1) / 2; // 찾고싶은 값을 index에 넣으면 부모 찾기 가능

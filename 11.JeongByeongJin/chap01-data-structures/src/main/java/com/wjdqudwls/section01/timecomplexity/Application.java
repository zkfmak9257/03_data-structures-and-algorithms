package com.wjdqudwls.section01.timecomplexity;
...
public class Application {
  public static void main(String[] args) {
    ...
    // 테스트용 정수 배열 선언 및 초기화
    int[] arr = {3, 1, 2, 15, 23, 19, 13, 20};

    System.out.println("상수 시간 O(1) 결과 : " + getFirst(arr));
    System.out.println("선형 시간 O(n) 결괴 : " + Arrays.toString((reverse(arr))));
    System.out.println("로그 시간 O(log n) 결과 : " + binarysearch(arr, 1));
...
//    }
   ...
   *  - 주로 탐색 공간을 절반씩 줄여 나가면 탐색하는 알고리즘에서 나타ㅏㄴㅁ
...
//  Arrays.sort(arr)
//    - 배열 원본 정렬
//    - Arrays.sort(arr)는 일반적으로 0(n log n) 의 시간 복잡도를 가짐
//    -> 정렬 시간은 제외하고 생각하자!
    Arrays.sort(arr);

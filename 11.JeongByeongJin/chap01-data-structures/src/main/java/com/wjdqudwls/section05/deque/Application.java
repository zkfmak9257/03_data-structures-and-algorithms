package com.wjdqudwls.section05.deque;
...
public class Application {
  public static void main(String[] args) {
    ...
    System.out.println("getList() 결과 : " + deque.getLast()); // 4

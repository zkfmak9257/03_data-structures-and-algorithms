...
/* Queue
* - 선입선출(First In First Out, FIFO) 원칙을 따르는 선형 자료 구조
*
* 주요 연산:
...
public class Application {
  public static void main(String[] args) {
    ...
    /* Collections 프레임워크에는 Queue 인터페이스를 구현한 여러 클래스가 존재함.
    * 그 중 LinkedList를 사용하여 연결 리스트 기반 Queue를 사용해볼 예정
    ...
    * */
    ...
    System.out.println("isEmpty() 확인 : " + queue.isEmpty()); // true

    queue.offer(4); // 큐 뒤에 추가
    System.out.println("isEmpty() 확인 : " + queue.isEmpty()); // false
